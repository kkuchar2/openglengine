...
/*
 ...
 EXHIBIT 1: USING THE EXAMPLE BINDINGS (imgui_impl_XXX.cpp files from the examples/ folder).
     ...
     // Initialize helper Platform and EngineRenderer bindings (here we are using imgui_impl_win32 and imgui_impl_dx11)
 ...
 EXHIBIT 2: IMPLEMENTING CUSTOM BINDING / CUSTOM ENGINE.
     ...
     // (In the examples/ app this is usually done within the ImGui_ImplXXX_Init() function from one of the demo EngineRenderer)
     int width, height;
...
void ImGui::UpdatePlatformWindows()
{
    ...
    for (int i = 1; i < g.Viewports.Size; i++)
    {
        ...
        // Apply Position and Size (from ImGui to Platform/EngineRenderer back-ends)
